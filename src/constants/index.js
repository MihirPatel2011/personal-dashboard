...
export const PERSONAL_TASK_PRIORITIES = [
  { id: 'high',   symbol: '🔴', label: 'High',   color: '#EF4444' },
  { id: 'medium', symbol: '🟡', label: 'Medium', color: '#F59E0B' },
  { id: 'low',    symbol: '🟢', label: 'Low',    color: '#22C55E' },
];

export const PERSONAL_TASK_CATEGORIES = [
...
// ─── Focus (Tasks · Timer · Stats) ──────────────────────────────────────────────
// Palette for Areas — picked to read well as solid chips on both themes.
export const AREA_COLORS = [
  '#7B96F5', '#00C896', '#F07560', '#A78BFA', '#F5A52A',
  '#5B8CF5', '#F472B6', '#2DD4BF', '#FB923C', '#34D399',
  '#818CF8', '#22D3EE',
];
...
// Priority scale (4 = most urgent). 0 / undefined = no priority set.
export const FOCUS_PRIORITIES = [
  { id: 4, label: 'Urgent', short: 'P1', color: '#F06060', dim: 'rgba(240,96,96,0.14)' },
  { id: 3, label: 'High',   short: 'P2', color: '#F5A52A', dim: 'rgba(245,165,42,0.14)' },
  { id: 2, label: 'Medium', short: 'P3', color: '#5B8CF5', dim: 'rgba(91,140,245,0.14)' },
  { id: 1, label: 'Low',    short: 'P4', color: '#00C896', dim: 'rgba(0,200,150,0.14)' },
];

export const PRIORITY_MAP = Object.fromEntries(FOCUS_PRIORITIES.map(p => [p.id, p]));
